...
class Prompt:
    def __init__(self, question, context):
        ...
        Make sure to give a source in the form of URLs whenever needed. Look for similar sources in languages other than the inputted query as well, try to be more open to multi-lingual queries.
